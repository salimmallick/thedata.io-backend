...
from ..core.storage.database import get_clickhouse_client, get_questdb_sender
import logging
...
async def get_realtime_metrics(
    ...
    metrics = await materialize_service.get_real_time_metrics(view_name, filters)
    return {
        "view": view_name,
...
async def get_timeseries_metrics(
    ...
    """Get time-series metrics from QuestDB"""
    try:
